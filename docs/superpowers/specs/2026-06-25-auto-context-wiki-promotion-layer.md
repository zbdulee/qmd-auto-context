...
```json
{"ts":"2026-06-25T00:00:00Z","trigger":"explicit_user_approval","title":"Config lives under .auto-context/settings.json","summary":"...","sources":["session"],"suggestedType":"decision","status":"generated"}
```
